...
class DateRangePicker extends React.Component {
  ...
  onFirstCalendarOpen() {
    ReactDOM.findDOMNode(this).children[0].querySelector(
      'button'
    ).tabIndex = -1;
    ReactDOM.findDOMNode(this)
      .children[1].querySelectorAll('button')
  ...
  render() {
    ...
    return (
      <ReactDateRangePicker
        ...
        calendarIcon={
          <CalendarSelect
            state={this.state.isCalendarOpen ? 'open' : 'closed'}
          />
        }
        onChange={this.handleDatesChange}
        onCalendarOpen={() => {
          if (this.state.wasCalendarOpen === false) this.onFirstCalendarOpen();
