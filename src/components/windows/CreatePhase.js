                ...
                <div className="column">
                    <div className="form-card">
                        <FormRow title={t('phaseForms:create.phase')}>
                            <Select
                                ...
                                options={[
                                    ...
                                    {label: t('phaseForms:phases.transport'), value: 'transport'},
                        ...
                        <FormRow title={t('phaseForms:create.date')}>
                            <DatePicker name="date" value={this.state.date} onChange={this.handleChange}/>
                        </FormRow>

                        <FormRow border={false}>
                            <button className="btn btn-text" onClick={() => this.handleCreatePhase()}>{t('phaseForms:create.create')}</button>
                        </FormRow>
                    </div>
                </div>
            </div>
