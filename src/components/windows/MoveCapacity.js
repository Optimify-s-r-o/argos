  ...
  render() {
    ...
    return [
      ...
      <div key='buttons' className='moveCapacityButtons'>
        <button
          onClick={() => this.onClick(METHOD_CAPACITY_ALL, params.windowId)}
        >
          {t('phaseForms:moveCapacity.buttons.all')}
          <br />({params.maxCapacity})
        </button>
        <button
          onClick={() => this.onClick(METHOD_CAPACITY_FILL, params.windowId)}
        >
        ...
        <div className='customCapacity'>
          ...
          <button
            onClick={() =>
              this.onClick(METHOD_CAPACITY_CUSTOM, params.windowId)
            }
          >
      ...
      <div key='cancel' className='cancelRow'>
        <button className='btn btn-text btn-cancel' onClick={this.onCancel}>
