            ...
            <div className="Days">
                {
                    this.props.days.map((day, key) => {
                        ...
                        phases.forEach(phase => {
                            capacities[phase] = {
                                absolute: {
                                    used: this.props.capacities[key] ? this.props.capacities[key][phase].used : null,
                                    available:this.props.capacities[key] ? this.props.capacities[key][phase].available : null,
                                    full: this.props.capacities[key] ? this.props.capacities[key][phase].used + this.props.capacities[key][phase].available : null,
                                },
                                percentage: this.props.capacities[key] ? 100 - Math.round(this.props.capacities[key][phase].used / (this.props.capacities[key][phase].used + this.props.capacities[key][phase].available) * 100) : null, // TODO: dividing by 0
                            };
                        });
